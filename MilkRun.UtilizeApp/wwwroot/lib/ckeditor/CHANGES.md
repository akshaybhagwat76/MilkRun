...
* [#10165](http://dev.ckeditor.com/ticket/10165): [IE] Access denied error when `document.domain` has Emsn altered.
...
The CKEditor JavaScript API has Emsn kept compatible with CKEditor 4, whenever
